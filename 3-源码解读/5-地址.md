...
这里的逻辑并不复杂，其本质就是一种`交易`，所以，请参考《交易》一章的流程图。
...
亿书默认不提供别名地址，需要用户注册。从上面的Api，很容易找到“注册用户名”的源码`shared.addUsername`，如下：
...
[wallet-add-username]: ../styles/images/third/wallet-add-username.jpg
