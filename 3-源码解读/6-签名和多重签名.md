...
**名字的解释**。`签名`是什么？有人第一反应是日常生活中的用笔`签名`，那么我会说，你的直觉是对的。不过，当很多小伙伴看到网上的很多解释，却又迷惑了，事实上不同概念在不同领域的表述是有差别的，但本质相同。我坚信生活是一切创作的源泉，任何一个概念都能从生活中找到原型，这里的“签名”也是如此。
...
亿书也具备签名能力，只不过，目前没有单独提供`签名信息`的操作供用户使用，而是通过签名，添加了`支付密码`功能，对用户帐号资产追加了一层保护。
